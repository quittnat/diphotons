...
# ./bkg_bias.py --analyze-bias --bias-files full_analysis_spring16v1_sync_v1_2705_cert/studies_0610/bias_study_toys_from_mc_unbinned_dijet/toys.root --bias-files full_analysis_spring16v1_sync_v1_2705_cert/bias_study_toys_from_mc_unbinned_pluskfactor/toys.root --dont-draw --scale-bias 10.07 --bias-labels default --analyze-categories EBEE --bias-labels pNNLO --bias-files full_analysis_spring16v1_sync_v1_2705_cert/bias_study_toys_from_mc_unbinned_minuskfactor/toys.root --bias-labels mNNLO --bias-files full_analysis_spring16v1_sync_v1_2705_cert/bias_study_toys_from_mc_unbinned_plusQCD/toys.root --bias-labels pFakes -O /afs/cern.ch/user/m/mquittna/www/diphoton/spring16/full_analysis_spring16v1_sync_v1/bias_study_default --legend-labels
