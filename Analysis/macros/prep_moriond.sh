...
#./templates_maker.py --input-dir=/shome/mquittna/CMSSW/CMSSW_7_6_3/src/diphotons/Analysis/config/singlePhoton_data_76_final/  -o  templates_moriond16v1_sync_v4_data_singlephoton.root --prepare-data  --only-subset="singlePho" --load templates_maker.json,templates_maker_prepare.json

#./templates_maker.py --load templates_maker_prepare.json,templates_maker.json --read-ws  templates_moriond16v1_sync_v4_data_singlephoton.root,templates_moriond16v1_sync_v4_data.root --mix-templates  --store-new-only -o mix_moriond16v1_sync_v4_data.root
...
##full mass range
./templates_fitter.py --load templates_fitter_cmsswcomparison.json,lumi.json --read-ws templates_moriond16v1_sync_v4_data.root,mix_moriond16v1_sync_v4_data.root -O /afs/cern.ch/user/m/mquittna/www/diphoton/bkg_decomposition_moriond16v1_sync_v4_data/ -o compared_moriond16v1_sync_v4_data_fullmass.root --compare-templates --fit-massbins 1,1,0 --template-binning="0.0,0.1,5.0,15.0" --no-mctruth --store-new-only --lumi 2.7
...
./templates_fitter.py --load templates_fitter_cmsswcomparison.json,lumi.json --saveas pdf,convert_png,root --read-ws templates_moriond16v1_sync_v4_data.root,compared_moriond16v1_sync_v4_data.root,fitted_moriond16v1_sync_v4_data.root -O /afs/cern.ch/user/m/mquittna/www/diphoton/bkg_decomposition_moriond16v1_sync_v4_data/ --plot-purity --plot-closure template_mix --plot-purityvalue fraction --no-mctruth --lumi 2.7 --full-error -o purity_moriond16v1_sync_v4_data.root --store-new-only --blind
#sigregion
