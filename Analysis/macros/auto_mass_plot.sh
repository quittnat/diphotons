...
## scale MC by k-factor
 ...
 ##    --process GGJets\*EB\* \
 ##    --file  /afs/cern.ch/user/m/musella/public/workspace/exo/$mcfilename/output.root   --move cicNoChIsoGenIso:cicNoChIso,cicNoChIsoNonGenIso:cicNoChIso,cicGenIso:cic,cicNonGenIso:cic \
